...
<center><h4><font color="green">Product Successfully Added to Cart!</font></h4></center>
<br>
<br>
<br>


 <center><a href="myCart" class="btn btn-info" role="button">View Cart <span class="glyphicon glyphicon-shopping-cart"></span></a>
 &nbsp; &nbsp; &nbsp;
 <a href="home" class="btn btn-success" role="button">Shop More <span class="glyphicon glyphicon-shopping-cart"></span></a>
&nbsp; &nbsp; &nbsp;
<a href="payment" class="btn btn-warning" role="button">Proceed To Pay <span class="glyphicon glyphicon-forward"></span></a></center>
