...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="homepage.html">electronica</a>
    </div>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class = "dropdown">
            <a href = "#" class = "dropdown-toggle" data-toggle = "dropdown">Products<b class = "caret"></b></a>
               ...
               <li><a href = "comp.html">Computer & Accessories</a></li>
               <li><a href = "tv.html">Television</a></li>
               <li><a href = "mobile.html">Cell Phones</a></li>
               <li><a href = "#">Home Appliances</a></li>
               <li class = "divider">Watches</li>
               <li><a href = "#">More</a></li>
            </ul>
         </li>		
...
<div class="form-group">
<form name='registration' onSubmit="return formValidation();" action="Success.html">    

<label for="userid">User id:</label>
<input type="text" class="form-control" name="userid" placeholder="Enter User id" />  
<label for="passid">Password:</label> 
<input type="password" class="form-control" name="passid" placeholder="Enter Password"/>  
...
<input type="text" class="form-control" name="email" size="50" placeholder="Enter Email Id"/>
<br>  
<label for="mob">Mobile:</label>  
<input type="text" class="form-control" name="mob" placeholder="Enter Mobile Number"/>
<br><label id="gender">Sex:</label>  
