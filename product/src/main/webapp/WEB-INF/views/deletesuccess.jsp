...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="homepage.html"><span class="glyphicon glyphicon-home orange"></span> Home</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="#">Daily Deals</a></li>
        <li class = "dropdown">
...
<center><h4><font color="red">Product Deleted Successfully !</font></h4></center>


 <center><a href="2" class="btn btn-info" role="button">Click To View Product List</a></center>
